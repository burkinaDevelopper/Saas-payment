        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 space-y-5">
                    ...
                    <x-input-label for="card-holder-name" :value="__('Detenteur de la carte')" />
                    <x-text-input id="card-holder-name"  type="text" class="mt-2 mb-3"  />
                    
                    <!-- Stripe Elements Placeholder -->
                    <div id="card-element" class="p-5 shadow rounded"></div>
                    
                    <x-primary-button id="card-button" data-secret="{{ $intent->client_secret }}" class="mt-4 mb-2">
                        {{ __("S'abonner") }}
                    </x-primary-button>
    ...
    <script>
        ...
        cardButton.addEventListener('click', async (e) => {
            ...
            if (error) {
                ...
                console.log(setupIntent.payment_method,selectedPlan);
            }
        });
    </script>
    @endpush
